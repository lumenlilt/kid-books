...
| 素材包 | 作者 | 授權 | 來源 | 用在 |
|---|---|---|---|---|
| Kenney Furniture Kit 2.0 | Kenney (kenney.nl) | CC0-1.0 | <https://kenney.nl/assets/furniture-kit> | `models/kenney/furniture/*` |
| Kenney Interface Sounds 1.0 | Kenney (kenney.nl) | CC0-1.0 | <https://kenney.nl/assets/interface-sounds> | `sfx/kenney/*` |
